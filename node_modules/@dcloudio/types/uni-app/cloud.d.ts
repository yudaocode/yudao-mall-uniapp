declare namespace UniCloudClientNamespace {
...
interface UniCloud {
   ...
   */
  init(options: UniCloudClientNamespace.UniCloudOptions): UniCloud;
  /**
   * 获取登录对象
   *
   ...
   */
  customAuth(): UniCloudClientNamespace.Auth;
  /**
   * 调用云函数
   *
   ...
   */
  callFunction(options: UniCloudClientNamespace.CallFunctionOptions): Promise<any>;
  /**
   * 引用云对象
   *
   * 文档: [http://uniapp.dcloud.io/uniCloud/cloud-obj](http://uniapp.dcloud.io/uniCloud/cloud-obj)
   */
  importObject(objectName: string, importObjectOptions?: UniCloudClientNamespace.ImportObjectOptions): any;
  /**
   * 上传文件到云端
   *
   * 文档: [http://uniapp.dcloud.io/uniCloud/storage?id=uploadfile](http://uniapp.dcloud.io/uniCloud/storage?id=uploadfile)
   */
  uploadFile(options: UniCloudClientNamespace.UploadFileOptions): Promise<any>;
  /**
   * 选择并上传文件
   *
   ...
   */
  chooseAndUploadFile(options: UniCloudClientNamespace.ChooseAndUploadFileOptions): Promise<any>;
  /**
   * 删除云端文件
   *
   * 文档: [http://uniapp.dcloud.io/uniCloud/storage?id=deletefile](http://uniapp.dcloud.io/uniCloud/storage?id=deletefile)
   */
  deleteFile(options: UniCloudClientNamespace.DeleteFileOptions): Promise<any>;
  /**
   * 获取文件临时链接
   *
   * 文档: [http://uniapp.dcloud.io/uniCloud/storage?id=gettempfileurl](http://uniapp.dcloud.io/uniCloud/storage?id=gettempfileurl)
   */
  getTempFileURL(options: UniCloudClientNamespace.GetTempFileURLOptions): Promise<any>;
  /**
   * 获取数据库实例
   *
   * 文档: [http://uniapp.dcloud.io/uniCloud/jql?id=jssdk](http://uniapp.dcloud.io/uniCloud/jql?id=jssdk)
   */
  database(options?: UniCloudClientNamespace.UniCloudOptions): UniCloudClientNamespace.Database;
  /**
   * 获取当前用户缓存在token内的信息
   *
   ...
   */
  getCurrentUserInfo(): UniCloudClientNamespace.LocalUserInfo;
  /** 事件回调 */
  ...
  */
  onResponse(callback: (result?: UniCloudClientNamespace.UniCloudResponseEvent) => void): void
  /**
   ...
   */
  offResponse(callback: (result?: UniCloudClientNamespace.UniCloudResponseEvent) => void): void
  /**
   * 监听需要登录事件
   *
   * 文档: [http://uniapp.dcloud.io/uniCloud/client-sdk?id=on-need-login](http://uniapp.dcloud.io/uniCloud/client-sdk?id=on-need-login)
  */
  onNeedLogin(callback: (result?: UniCloudClientNamespace.UniCloudNeedLoginEvent) => void): void
  /**
   * 移除监听需要登录事件
   *
   ...
   */
  offNeedLogin(callback: (result?: UniCloudClientNamespace.UniCloudNeedLoginEvent) => void): void
  /**
   * 监听token刷新事件
   *
  ...
  */
   onRefreshToken(callback: (result?: UniCloudClientNamespace.UniCloudRefreshTokenEvent) => void): void
   /**
    * 移除监听token刷新事件
    *
    ...
    */
   offRefreshToken(callback: (result: UniCloudClientNamespace.UniCloudRefreshTokenEvent) => void): void
  /**
   * 添加拦截器
   *
