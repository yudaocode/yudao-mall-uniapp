	...
	<view>
		<view class='my-promotion'>
            ...
            提现记录<text class='iconfont icon-xiangyou'></text>
				...
				<view class='num'>{{ fen2yuan(spreadInfo.brokeragePrice) }}</view>
				<view class='profit acea-row row-between-wrapper'>
					<view class='item'>
						<view>昨日收益</view>
						<view class='money'>{{ fen2yuan(spreadInfo.yesterdayBrokeragePrice || 0) }}</view>
					</view>
					<view class='item'>
						<view>累积已提</view>
						<view class='money'>{{ fen2yuan(spreadInfo.withdrawBrokeragePrice || 0) }}</view>
					</view>
				</view>
			</view>
			<!-- #ifdef H5 -->
